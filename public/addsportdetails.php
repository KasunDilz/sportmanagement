        ...
        <div id="div-1" class="body">
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="tes\xt" id="text1" placeholder="Enter sport" class="form-control" name="sport">
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Captain</label>

                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter captain name" class="form-control" name="captain_name">
                    </div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                    <label for="tel" class="control-label col-lg-4">Captain Contact No</label>

                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter captain contact no" class="form-control" name="captain_con">
                    </div>
                </div>

                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Vice Captain</label>

                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter vice captain name" class="form-control" name="vcaptain_name">
                    </div>
                </div>

                
                <div class="form-group">
                    <label for="tel" class="control-label col-lg-4">Vice Captain Contact No</label>

                    <div class="col-lg-8">
                        <input type="tel" id="text1" placeholder="Enter vice capatain contact no" class="form-control" name="vcaptain_con">
                    </div>
                </div>
...
if( isset($_POST['submit'])){
  ...
  $captain_con=$_POST['captain_con'];
  $vcaptain_name = $_POST['vcaptain_name'];
  $vcaptain_con = $_POST['vcaptain_con'];
 
$sql1 = "INSERT INTO add_sport_details(sport,captain_name,captain_con,vcaptain_name,vcaptain_con)
 VALUES('$sport','$captain_name','$captain_con','$vcaptain_name','$vcaptain_con')";
