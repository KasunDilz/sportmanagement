                        ...
                        <ul id="menu" class="bg-blue dker">
                                 ...
                                 <li class="">
                                    ...
                                    <ul class="collapse">
                                      ...
                                      <li>
                                        <a href="form-validation.html">
                                          <i class="fa fa-angle-right"></i>&nbsp; View Newa </a>
                                      </li>
...
<div class="col-lg-12 col-md-10">
    <div class="box dark">
        ...
        if (isset($_GET['nic'])) {
          ...
          $sql = "SELECT * FROM add_user WHERE nic_no = '$id'";
          ...
          while ($row = mysqli_fetch_assoc($res)) { ?>
            ...
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter Full Name" class="form-control" name="name" value="<?php echo $row['name']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter NIC No" class="form-control" name="nic_no" value="<?php echo $row['nic_no']; ?>" disable>
                    </div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter Faculty" class="form-control" name="faculty" value="<?php echo $row['faculty']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter Registration No" class="form-control" name="reg_no" value="<?php echo $row['reg_no']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="tel" id="text1" placeholder="Enter Contact no" class="form-control" name="contact_no" value="<?php echo $row['contact_no']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="date" id="text1" placeholder="Enter dob" class="form-control" name="dob" value="<?php echo $row['dob']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="email" id="text1" placeholder="Enter Email" class="form-control" name="email" value="<?php echo $row['email']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                       <input type="radio" name="gender" value="male" checked value="<?php echo $row['gender']; ?>"> Male<br>
                       <input type="radio" name="gender" value="female" value="<?php echo $row['gender']; ?>"> Female<br>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" type="password" id="pass1"
                               data-original-title="Please use your secure password" data-placement="top"/ name="password" value="<?php echo $row['password']; ?>">
                               <br>
                               <br>
...
$sql1 = "UPDATE add_user SET name='$name',faculty='$faculty',reg_no = '$reg_no',contact_no = '$contact_no',dob = '$dob',email= '$email',gender= '$gender',password='$password' WHERE nic_no='$id'";
