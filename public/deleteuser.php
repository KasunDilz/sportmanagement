        ...
        <div id="div-1" class="body">
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="text1" placeholder="Enter a NIC No" class="form-control" name="nic_no">
...
$sql2 = "DELETE FROM add_user WHERE nic_no='$nic_no'";
$sql3q=mysqli_query($con,$sql2);
